...
const BADGES = [
    { score: 100, url: '/models/badges/FishTrophy_-compressed.glb',  label: '🏆 Trofi Ikan',     title: 'Trofi Ikan Mas',     desc: 'Simbol pencapaian tertinggi Anda dalam menjelajahi dan mempelajari keindahan serta konservasi ekosistem laut.', gradient: 'from-yellow-300 via-amber-400 to-yellow-600', ring: 'bg-amber-400/20', shadow: 'shadow-[0_0_100px_-20px_rgba(251,191,36,0.15)]' },
    { score: 90,  url: '/models/badges/GoldMedal-fast-normal.glb',   label: '🥇 Medali Emas',    title: 'Medali Emas',        desc: 'Pencapaian luar biasa! Anda sangat menguasai materi secara mendalam.', gradient: 'from-yellow-200 via-yellow-400 to-amber-500', ring: 'bg-yellow-400/20', shadow: 'shadow-[0_0_100px_-20px_rgba(250,204,21,0.15)]' },
    { score: 75,  url: '/models/badges/SilverMedal-fast-normal.glb', label: '🥈 Medali Perak',   title: 'Medali Perak',       desc: 'Kerja bagus! Anda memiliki pemahaman yang kuat tentang ekosistem laut.', gradient: 'from-slate-200 via-slate-300 to-gray-400', ring: 'bg-slate-300/20', shadow: 'shadow-[0_0_100px_-20px_rgba(203,213,225,0.15)]' },
    { score: 50,  url: '/models/badges/BronzeMedal__-compressed.glb',label: '🥉 Med. Perunggu',  title: 'Medali Perunggu',    desc: 'Langkah awal yang hebat. Terus tingkatkan pengetahuan kelautan Anda!', gradient: 'from-orange-300 via-orange-500 to-amber-700', ring: 'bg-orange-500/20', shadow: 'shadow-[0_0_100px_-20px_rgba(249,115,22,0.15)]' },
];
